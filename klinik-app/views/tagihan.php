...
if (isset($db)) {
    try {
         ...
         */
        $query = $db->query("
            -- 1. Ambil data transaksi yang sudah Lunas melalui View
            SELECT 
            ...
            -- 2. Ambil data yang Belum Lunas secara real-time
            SELECT 
                t.tagihan_id,
        ...
        // Catat eror asli ke log server untuk debugging internal
        error_log("Database Error pada tagihan.php: " . $e->getMessage());
        
        // Set notifikasi peringatan di halaman web
        $error_message = "Sistem berjalan dalam Mode Cadangan. View 'v_dashboard_keuangan_lunas' tidak ditemukan atau bermasalah di database Railway.";
        ...
        try {
            ...
            ");
            $daftar_tagihan = $query_fallback->fetchAll(PDO::FETCH_ASSOC);
        } catch (PDOException $ex) {
            $error_message = "Gagal memuat data billing: " . $ex->getMessage();
        }
    }
}
?>
            ...
            <main class="content-area">
                <div class="table-container">
                    ...
                    <?php if ($error_message): ?>
                        <div style="background: #fff3cd; color: #856404; padding: 12px 15px; margin-bottom: 20px; border-radius: 4px; border: 1px solid #ffeeba; font-size: 0.9rem;">
                            ...
                            <?php if (!empty($daftar_tagihan)): ?>
                                <?php foreach ($daftar_tagihan as $tagihan): ?>
                                    <?php 
                                        ...
                                        // Breakdown proporsi biaya untuk kebutuhan modal ringkas
        ...
        function setupModalTriggers() {
            ...
            detailButtons.forEach(button => {
                button.onclick = function() {
                    ...
                    // Menggunakan flex agar rata tengah sempurna sesuai standar CSS modern
